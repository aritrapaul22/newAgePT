...
Example of SequentialTaskSet, CsvRead
"""

from locust import HttpUser, task, constant, SequentialTaskSet
from myTestData import CsvRead
...
class MyScript(SequentialTaskSet):
    ...
    def place_order(self):
        test_data = CsvRead("mydummyData.csv").read()
        # print(test_data)
        ...
        res = self.client.post("/post", catch_response=True, name=name, data=data)
